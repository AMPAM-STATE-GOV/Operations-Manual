...
Official operations manual for AMPAM nationals, officials, and developers.

**Authority Chain:** Madrid Protocol 1880 → AMPAM → ADDIF Registry

**Treaty Basis:** Treaty of Peace and Friendship 1786/1836 | Madrid Protocol 1880 | General Act of Algeciras 1906 | Vienna Convention | UNDRIP | ICJ Case No. 11
...
- [Star Advancement](sections/star_advancement.md)
- [Estate Structure](sections/estate_structure.md)
- [Tax Position](sections/tax_position.md)
- [Notice Package](sections/notice_package.md)
- [Foundational Documents](sections/foundational_docs.md)
- [National Master File](sections/nmf.md)
- [Dispute Resolution](sections/dispute_resolution.md)
...
- [Registration Process](sections/registration_process.md)
- [Governance Operations](sections/governance_ops.md)
